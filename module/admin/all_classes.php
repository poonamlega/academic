        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">All Classes</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active"><a href="all_classes.php">All Classes</a></li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                     ...
                     <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Below is list of all Classes</h6>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $i = 1;
                                                $get_class_data = "select * from classes order by 1 desc";
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><a href="delete_class.php?class_id=<?php echo $row_class_data['class_id']; ?>"><span class="label label-danger">Delete</span></a></td>
                                                
                                                <td><?php echo $row_class_data['class_name']; ?></td>
