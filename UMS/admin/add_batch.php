        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add New Batch</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active"><a href="add_class.php">Add new Batch</a></li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                     ...
                     <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">You can add new batch here</h6>
                                
                                <form method="post" action="">
                                    <p>Enter Batch Name</p>
                                    <input class="input form-control" placeholder="Enter Batch Name" type="text" name="batch_name" required>
                                    <br>
...
<?php 
      if(isset($_POST['add']))
      {
        ...
        $check_previous = "select * from batch where batch_name = '$batch_name'";
        $run_check_previous = mysqli_query($con,$check_previous);
        $row_check = mysqli_num_rows($run_check_previous);
        if($row_check==0)
        {
        $insert_batch = "insert into batch(batch_name)values('$batch_name')";
        if($run_insert_batch = mysqli_query($con,$insert_batch)){
            echo "<script>
           ...
           echo "<script>alert('Batch is already in database !!');</script>";
        }
      }
