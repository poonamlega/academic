        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Assign Teachers to optional classes</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active"><a href="teacher_details.php">Teacher Details</a></li>
                        <li class="breadcrumb-item active"><a href="assign_teacher.php">Assign teachers to optional class</a></li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                     ...
                     <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Assign teachers to optional class</h4>
                                ...
                                <form method="post" action="">
                                    ...
                                    <br>
                                    <p>Select Class</p>
                                    <select name="batch_id" class="input form-control" required>
                                        <option value="">Select a batch</option>
                                        <?php 
                                            $get_class = "select * from batch order by 1 desc";
                                            $run_class  = mysqli_query($con,$get_class);
                                            while($row_class = mysqli_fetch_array($run_class))
                                            {
                                        ?> 
                                        <option value="<?php echo $row_class['batch_id']; ?>"><?php echo $row_class['batch_name']; ?></option>
                                        <?php } ?>
                                    </select>
                                    <br>  
                                    <p>Class incharge ?</p>
...
<?php 
     if(isset($_POST['assign']))
     {
        ...
        $check_previous  = "select * from assigned_teachers where teacher_id = '$teacher_id' and batch_id = '$batch_id'";
        ...
        if($row_check_previous ==0)
        {
            ...
            $insert_data = "insert into assigned_teachers (teacher_id,batch_id,is_incharge) values('$teacher_id','$batch_id','$is_incharge')";

            $run_insert_data = mysqli_query($con,$insert_data);

            $get_class_data = "select * from batch where batch_id = '".$_POST['batch_id']."'";
            $run_class_data = mysqli_query($con,$get_class_data);
            $row_class_data = mysqli_fetch_array($run_class_data);

            $batch_name = $row_class_data['batch_name'];
            $notification = "Admin Assigned you ".$batch_name;
            if($run_insert_data)
            {
                ...
                echo "<script>alert('Teacher Successfully Assigned to Batch !!');</script>";
            }
        }
        else{
