        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add New Class</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active"><a href="add_class.php">Add new Class</a></li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                     ...
                     <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">You can add new class here</h6>
                                
                                <form method="post" action="">
                                    <p>Enter Class Name</p>
                                    <input class="input form-control" placeholder="Enter Class Name" type="text" name="class_name" required>
                                    <br>
...
<?php 
      if(isset($_POST['add']))
      {
        ...
        $check_previous = "select * from classes where class_name = '$class_name'";
        ...
        if($run_insert_class = mysqli_query($con,$insert_class)){
            echo "<script>
           ...
           echo "<script>alert('Class is already in database !!');</script>";
        }
      }
