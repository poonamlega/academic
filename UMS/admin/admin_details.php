                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $i = 1;
                                                $get_admin_data = "select * from admins order by 1 desc";
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><a href="delete_admin.php?admin_id=<?php echo $row_admin_data['admin_id']; ?>"><span class="label label-danger">Delete</span></a></td>
                                                <td><a href="edit_admin.php?admin_id=<?php echo $row_admin_data['admin_id']; ?>"><span class="label label-primary">Edit</span></a></td>
                                                <td><?php echo $row_admin_data['admin_email']; ?></td>
                                                <td><?php echo $row_admin_data['admin_pass']; ?></td>
                                         <?php $i++;  } ?>
                                            </tr>
