        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Notifications Results</h3> </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="recent-meaasge">
                                    <?php 
                                         $get_all_notifications = "select * from notifications where reciever_id = '".$row_student['student_id']."' and send_to = 'student' order by 1 desc";
                                ...
                                <?php } ?>
                                   ...
                                   <?php 
                                          $update_seen = "update notifications set seen='1' where reciever_id = '".$row_student['student_id']."' and send_to = 'student'";
