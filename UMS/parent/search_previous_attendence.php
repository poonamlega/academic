        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row" style="background-color: white;padding: 20px;">
                                ...
                                <div class="col-md-4">
                                    <input class="input form-control" type="text" placeholder="Select Attendence Date" onfocus="(this.type='date')" onblur="(this.type='text')" name="attendence_date"  required>
                                </div>
                ...
                <div class="row">
                    ...
                    <?php 
                            if(isset($_GET['attendence_date']))
                            {
                                $get_attendence = "select * from attendence where student_id = '".$row_student['student_id']."' and date = '".$_GET['attendence_date']."'";
                                $run_attendence = mysqli_query($con,$get_attendence);
                                $row_attendence = mysqli_fetch_array($run_attendence);

                                ?>
                      <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Attendence of <?php echo $row_student['student_name']; ?></h4>
                                <h6 class="card-subtitle">Here you can see attendence of <?php echo $row_student['student_name']; ?> (<?php echo $_GET['attendence_date']; ?>)</h6>
