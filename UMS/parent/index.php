            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 card" style="background-color: white;">
                        <center><h4>Welcome in <?php echo $row_student['student_name']; ?> 's Profile</h4>
                            <img src="../student_images/<?php echo $row_student['student_image']; ?>" width="100">
                        </center>
                    </div>
                    ...
                    <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-bell f-s-40 color-warning"></i></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2>2</h2>
