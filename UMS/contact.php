...
<head>
  ...
  <link rel="shortcut icon" href="assets/images/aschoolicon-122x122.png" type="image/x-icon">
  <meta name="description" content="university management system online">
...
<body>
  <!-- menu -->
  <?php 
      include("includes/parts/menu.php");
  ?>

<section class="engine"><a href="https://mobirise.me/f">easy site builder</a></section><section class="mbr-section form1 cid-rjmBDE4ACH" id="form1-5">
